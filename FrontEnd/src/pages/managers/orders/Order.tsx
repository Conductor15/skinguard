...
const Order = () => {
    ...
    const filteredDoctors = doctorsData.filter(doctor =>
        ...
        doctor.Patient.toLowerCase().includes(searchTerm.toLowerCase()) ||
        doctor.Total.toLowerCase().includes(searchTerm.toLowerCase()) ||
        doctor.Date.includes(searchTerm.toLowerCase()) ||
        doctor.ListofMedicines.includes(searchTerm.toLowerCase()) ||
            ...
            <div className="doctor_table">
                ...
                <div className="doctor_table_header">
                    <div className="doctor_table_header_grid">
                        <div>ID</div>
                        <div>Full name</div>
                        <div className="doctor_cell_specialty">Total</div>
                        <div className="doctor_cell_experience">Date</div>
